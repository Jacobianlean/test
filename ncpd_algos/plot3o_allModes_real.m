...
% This function is to plot the median convergence curve for real data experiments
%% Input handling
...
ax1 = axes('Position', [left_main,  0.15, 0.38, 0.75]); %  - f vs iteration
ax2 = axes('Position', [right_main, 0.15, 0.38, 0.75]); %  - f vs time
